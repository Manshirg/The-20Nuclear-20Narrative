      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card className="mb-12 border-l-4 border-l-nuclear-blue bg-blue-50 dark:bg-blue-950/20">
          <CardContent className="pt-6">
            <p className="text-foreground/90 leading-relaxed">
              This site was created for a U.S. History final project by Manshir Gill. All sources used across the website are cited using Chicago-style footnotes. Below is the full bibliography organized by source type. No annotations are included, in accordance with project requirements.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-12">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Original documents, speeches, government records, and contemporary materials
            </p>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-l-4 border-l-nuclear-orange bg-orange-50 dark:bg-orange-950/20">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              All citations follow the Chicago Manual of Style (17th edition) format for history papers. 
              Footnotes throughout the website correspond to these sources and provide specific page numbers 
              and additional context where applicable.
            </p>
            <div className="grid md:grid-cols-2 gap-4 text-xs text-muted-foreground">
              <div>
                <strong className="text-foreground">Primary Sources:</strong> Original documents, government records, speeches, and contemporary materials from the historical periods studied.
              </div>
              <div>
                <strong className="text-foreground">Secondary Sources:</strong> Scholarly books and articles written by historians and researchers analyzing nuclear history.
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mt-8 bg-muted/20">
          <CardContent className="pt-6">
            <div className="text-center">
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">Academic Standards:</strong> This bibliography meets college-level research requirements 
                with a combination of primary sources, peer-reviewed secondary sources, and authoritative 
                institutional materials spanning the full chronological scope of the study (1877-2016).
              </p>
            </div>
          </CardContent>
        </Card>
